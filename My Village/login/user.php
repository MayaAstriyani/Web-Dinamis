		...
		<div class="badan">
            ...
            <table border="1" cellpadding="10" cellspacing="0">
              ...
              <tr>
                <td><?= $i;  ?></td>
                <td>
                  <a href="ubah_User.php?ID=<?= $row["ID"];?>"><i class="fa fa-pencil fa-fw"></i></a> |
                  <a href="hapus_User.php?id=<?= $row["ID"];?>" onclick="return confirm('Yakin Ingin Dihapus?');"><i class="fa fa-trash fa-fw"></i></a>
                </td>
                <td><?= $row["Nama"];?></td>
                <td><?= $row["Email"];  ?></td>
                <td><?= $row["Password"];  ?></td>
