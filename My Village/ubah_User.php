...
$artikel =query("SELECT *FROM user WHERE id = $ID")[0];
 ...
 <body>
   <div class="Loginbox">
     ...
     <form class="" action="" method="post">
       ...
       <input style="height:20px;" type="text" required name="nama" value="<?= $artikel["nama"]; ?>" autocomplete="off" placeholder="Judul Berita"><br><br>
       ...
       <input type="submit" name="button" value="Ubah"><br>
     </form>
